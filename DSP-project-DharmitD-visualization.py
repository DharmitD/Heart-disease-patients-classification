...
# plotting the violinplot for age w.r.t. target
...
# plotting the violinplot for resting blood pressure w.r.t. target
...
# plotting the violinplot for fasting-blood pressure w.r.t. target
sns.violinplot(x="target",y="fbs", hue="target", data=data);
plt.xlabel('Whether patients have a heart disease or no(0=No , 1=Yes)', fontsize=14)
plt.ylabel('fasting blood sugar > 120 mg/dl (1 = true; 0 = false)', fontsize=14)
plt.show()


# countplot for resting electrocardiographic results w.r.t. target
...
# plotting the violinplot for resting electrocardiographic results w.r.t. target
sns.violinplot(x="target",y="restecg", hue="target", data=data);
plt.xlabel('Whether patients have a heart disease or no(0=No , 1=Yes)', fontsize=14)
plt.ylabel('resting electrocardiographic results -- 0: normal, 1: having ST-T wave abnormality ,2:left ventricular hypertrophy', fontsize=14)
plt.show()


# countplot for maximum heart rate achieved w.r.t. target
sns.countplot('thalach', data=data,hue = 'target')
plt.xlabel('maximum heart rate achieved ', fontsize=14)
plt.ylabel('Count', fontsize=14)
plt.show()

# plotting the violinplot for maximum heart rate achieved w.r.t. target
sns.violinplot(x="target",y="thalach", hue="target", data=data);
plt.xlabel('Whether patients have a heart disease or no(0=No , 1=Yes)', fontsize=14)
...
# plotting the violinplot for exercise induced angina w.r.t. target
sns.violinplot(x="target",y="exang", hue="target", data=data);
plt.xlabel('Whether patients have a heart disease or no(0=No , 1=Yes)', fontsize=14)
plt.ylabel('exercise induced angina (1 = yes; 0 = no)', fontsize=14)
plt.show()


# countplot for ST depression induced by exercise relative to rest w.r.t target
...
# plotting the violinplot for maximum heart rate achieved w.r.t. target
sns.violinplot(x="target",y="oldpeak", hue="target", data=data);
plt.xlabel('Whether patients have a heart disease or no(0=No , 1=Yes)', fontsize=14)
plt.ylabel('ST depression induced by exercise relative to rest', fontsize=14)
plt.show()


# countplot for the slope of the peak exercise ST segment w.r.t. target
...
# plotting the violinplot for maximum heart rate achieved w.r.t. target
sns.violinplot(x="target",y="slope", hue="target", data=data);
plt.xlabel('Whether patients have a heart disease or no(0=No , 1=Yes)', fontsize=14)
plt.ylabel('the slope of the peak exercise ST segment(1=upsloping, 2=flat, 3=downsloping)', fontsize=14)
plt.show()


# countplot for thal w.r.t. target
sns.countplot('thal', data=data,hue = 'target')
plt.xlabel('thal', fontsize=14)
plt.ylabel('Count', fontsize=14)
plt.show()

# plotting the violinplot for thal w.r.t. target
sns.violinplot(x="target",y="thal", hue="target", data=data);
plt.xlabel('Whether patients have a heart disease or no(0=No , 1=Yes)', fontsize=14)
